...
OnlyPictureSettings numberedPictures(int count, const QString &pattern = QStringLiteral("%1.png")) {
    // Картинки 1..N без combo заданий (листание Вперёд/Назад в раннере).
    OnlyPictureSettings settings;
    settings.pictureCount = count;
    settings.imagePattern = pattern;
    return settings;
...
const ExerciseDefinition kDefinitions[] = {
    ...
    def(QStringLiteral("1.5"), ExerciseRunnerKind::E15, ExerciseProtocolKind::TimedBalls, {}, false, kYes),
    def(QStringLiteral("1.6"), ExerciseRunnerKind::E15, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    ...
    def(QStringLiteral("1.12"), ExerciseRunnerKind::Paint, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    ...
    def(QStringLiteral("1.15"), ExerciseRunnerKind::Puzzles, ExerciseProtocolKind::NumberedDoneTime,
        steps({QStringLiteral("1"), QStringLiteral("2"), QStringLiteral("3")}), false, kYes),
    ...
    def(QStringLiteral("1.22"), ExerciseRunnerKind::Puzzles, ExerciseProtocolKind::NumberedDoneTime,
        steps({QStringLiteral("Круг"), QStringLiteral("Квадрат"), QStringLiteral("Пирамида")}), false, kYes),
    ...
    def(QStringLiteral("1.28"), ExerciseRunnerKind::Puzzles, ExerciseProtocolKind::NumberedDoneTime,
        steps({QStringLiteral("1"), QStringLiteral("2")}), false, kYes),
    def(QStringLiteral("1.29"), ExerciseRunnerKind::Puzzles, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    def(QStringLiteral("2.1"), ExerciseRunnerKind::FindMark, ExerciseProtocolKind::DoneTimeOrHlp,
        steps({QStringLiteral("1"), QStringLiteral("2"), QStringLiteral("3")}), false, kYes),
    def(QStringLiteral("2.2"), ExerciseRunnerKind::FindMark, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    def(QStringLiteral("2.3"), ExerciseRunnerKind::FindMark, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    ...
    def(QStringLiteral("3.1.2"), ExerciseRunnerKind::OnlyPicture, ExerciseProtocolKind::NumberedDoneTime,
        steps({QStringLiteral("1"), QStringLiteral("2")}, QStringLiteral("%1.png")), false, kYes),
    def(QStringLiteral("3.1.7"), ExerciseRunnerKind::Puzzles, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    def(QStringLiteral("3.1.8"), ExerciseRunnerKind::Puzzles, ExerciseProtocolKind::OrHlpBallsRow,
        steps({QStringLiteral("1"), QStringLiteral("2")}), false, kYes),
    ...
    def(QStringLiteral("3.1.20"), ExerciseRunnerKind::Remember, ExerciseProtocolKind::NumberedDoneTime,
        steps({QStringLiteral("1"), QStringLiteral("2"), QStringLiteral("3")}), false, kYes),
    def(QStringLiteral("3.1.21"), ExerciseRunnerKind::Remember, ExerciseProtocolKind::OrHlpBallsRow,
        steps({QStringLiteral("1"), QStringLiteral("2"), QStringLiteral("3")}), false, kYes),
    def(QStringLiteral("3.1.23"), ExerciseRunnerKind::Puzzles, ExerciseProtocolKind::DoneTimeOrHlp,
        {}, false, kYes),
    def(QStringLiteral("3.1.24"), ExerciseRunnerKind::Puzzles, ExerciseProtocolKind::NumberedDoneTime,
        steps({QStringLiteral("Пример"), QStringLiteral("1"), QStringLiteral("2")}),
        false, kYes),
    ...
    def(QStringLiteral("3.2.11"), ExerciseRunnerKind::OnlyPicture, ExerciseProtocolKind::NumberedDoneTime,
        steps({QStringLiteral("1"), QStringLiteral("2"), QStringLiteral("3")}, QStringLiteral("%1.png")),
        false, kYes),
    def(QStringLiteral("3.3.1"), ExerciseRunnerKind::Paint, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    def(QStringLiteral("3.3.2"), ExerciseRunnerKind::Paint, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    def(QStringLiteral("3.3.3"), ExerciseRunnerKind::Paint, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
...
bool ExerciseConfig::usesAppendOnlyMultiStepLogic(const QString &exerciseId) {
    ...
    // и несколькими заданиями (combo № до Start).
    static const QStringList kIds = {
        ...
        QStringLiteral("3.1.20"),QStringLiteral("3.1.21"),
