...
const ExerciseDefinition kDefinitions[] = {
    ...
    def(QStringLiteral("4.1.2"), ExerciseRunnerKind::OnlyPicture, ExerciseProtocolKind::OrHlpBallsRow,
        steps({QStringLiteral("Пример"), QStringLiteral("1")}, QStringLiteral("%1.png")), false, kYes),
    def(QStringLiteral("4.1.4"), ExerciseRunnerKind::Remember2, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    ...
    def(QStringLiteral("4.1.7"), ExerciseRunnerKind::Remember, ExerciseProtocolKind::NumberedDoneTime,
        steps({QStringLiteral("1"), QStringLiteral("2"), QStringLiteral("3")}), false, kNo),
    def(QStringLiteral("4.1.8"), ExerciseRunnerKind::Cards, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    def(QStringLiteral("4.2.1"), ExerciseRunnerKind::Digits, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    def(QStringLiteral("4.2.2"), ExerciseRunnerKind::WordsLearning, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
    ...
    def(QStringLiteral("5.3.1"), ExerciseRunnerKind::OnlyPicture, ExerciseProtocolKind::DoneTimeOrHlp,
        steps({QStringLiteral("1"), QStringLiteral("2")}, QStringLiteral("%1.png")), false, kYes),
    def(QStringLiteral("5.4.2"), ExerciseRunnerKind::Wolf, ExerciseProtocolKind::DoneTimeOrHlp, {}, false, kYes),
};
