...
public:
    ...
    std::optional<SessionUser> login(const QString &fio, const QString &password);

    QList<UserRecord> fetchUsers();
    bool createUser(const QString &fio, const QString &password, const QString &role, const QString &mainId, QString *errorText);
    bool updateUser(const QString &id, const QString &fio, const QString &password, const QString &role, QString *errorText);
    ...
    bool savePatientAnamnesis(QString *patientId, const QString &licenseKey, const QString &html, QString *detectedFio, QString *detectedBirthDate, QString *errorText);
