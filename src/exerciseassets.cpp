...
QString ExerciseAssets::prepareOrHtml(
    ...
    const QString style = QStringLiteral(
        ...
        "#analis { display:block !important; white-space:normal; text-align:left !important; clear:both !important; float:none !important; margin:12px 0 0 0 !important; padding:0 !important; width:100% !important; }"
        "#div2 { clear:both; overflow:hidden; width:100%; }"
        "#div2 img { display:block; margin:8px auto; float:none; }"
