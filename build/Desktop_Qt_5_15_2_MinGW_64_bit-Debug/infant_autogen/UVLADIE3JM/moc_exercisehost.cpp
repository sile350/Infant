...
QT_MOC_LITERAL(4, 35, 22), // "exerciseOverlayChanged"
QT_MOC_LITERAL(5, 58, 7) // "visible"

    },
    "ExerciseHost\0closed\0\0protocolSaved\0"
    "exerciseOverlayChanged\0visible"
};
...
void ExerciseHost::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->exerciseOverlayChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (ExerciseHost::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ExerciseHost::exerciseOverlayChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void ExerciseHost::exerciseOverlayChanged(bool _t1)
{
